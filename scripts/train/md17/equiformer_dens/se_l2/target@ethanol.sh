...
OUTPUT_DIR="models/md17/equiformer_dens/N@6_L@2_C@128-64-32/target@ethanol/lr@5e-4_wd@1e-6_epochs@1500_w-f2e@80_exp@32_l2mae-loss/denoising-prob@0.25-std@0.05-coefficient@5.0-linear-decay-corrupt-ratio@0.25"
